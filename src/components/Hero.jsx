    ...
    return (
        <section ref={containerRef} className="relative h-screen min-h-[700px] text-[#0F172A] overflow-hidden bg-white" id="hero">
            ...
            <div className="absolute top-[50%] right-[-5%] -translate-y-1/2 w-[900px] h-[900px] z-1 pointer-events-none hidden lg:block opacity-[0.2]">
                ...
                <div className="absolute inset-0 bg-gradient-radial from-[#00FFFF33] to-transparent blur-[120px]" />
            </div>
            ...
            <div className="absolute inset-y-0 right-0 w-full lg:w-[60%] z-10 pointer-events-none flex items-end justify-end overflow-visible">
                <motion.div
                    ...
                    className="relative w-full h-[145%] bottom-[18%] right-[-10%]"
                ...
                >
                    ...
                    {/* Floating Accents */}
                    <div className="absolute top-[40%] right-[35%] w-6 h-6 rounded-full bg-[#00FFFF] blur-[4px] opacity-40 animate-pulse" />
                    <div className="absolute bottom-[30%] right-[65%] w-5 h-5 rounded-full bg-[#FF00FF] blur-[3px] opacity-30" />
                </motion.div>
            </div>
            ...
            <div className="relative z-30 w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-20 h-full flex items-center">
                <div className="w-full lg:w-1/2 pt-20">
                    ...
                    <motion.div
                        ...
                        className="relative p-8 md:p-12 rounded-[2rem] bg-white/10 lg:bg-transparent backdrop-blur-xl lg:backdrop-blur-none border border-white/20 lg:border-none flex flex-col justify-center text-white lg:text-[#0F172A]"
                    >
                        ...
                        >
                            ...
                            <span className="text-xs font-black uppercase tracking-[0.5em] text-indigo-600 dark:text-indigo-400">
                        ...
                        >
                            <motion.h1 
                                ...
                                className="font-black leading-[0.95] tracking-tighter mb-6 transition-all duration-300 group cursor-default"
                        ...
                        <motion.p 
                            ...
                            className="relative text-white/80 lg:text-[#0F172A]/70 text-base md:text-lg max-w-md mb-10 leading-relaxed font-bold"
                        >
                        ...
                        <div className="relative">
                            <motion.a
                                href="#projects"
                                className="px-12 py-5 bg-[#FF00FF] text-white font-black rounded-full shadow-[0_15px_40px_rgba(255,0,255,0.4)] hover:shadow-[0_20px_50px_rgba(255,0,255,0.6)] transition-all flex items-center gap-3 text-base border border-white/20"
