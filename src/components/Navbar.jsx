            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center">
                    <Link to="/" className="flex items-center gap-2.5 group cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
                        <div className="w-10 h-10 rounded-full overflow-hidden flex items-center justify-center shrink-0 mix-blend-multiply dark:mix-blend-screen shadow-sm">
                            <img
                                src="/favicon.png"
                                alt="SagayAI Lab"
                                className="w-full h-full object-cover scale-[1.35] group-hover:rotate-12 transition-transform duration-500"
                            />
                        </div>
