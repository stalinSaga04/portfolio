...
const Contact = () => {
    return (
        <section id="contact" className="py-20 md:py-32 bg-white dark:bg-slate-900 px-4 sm:px-6 lg:px-8 relative overflow-hidden transition-colors duration-500">
            {/* Background Decor */}
            <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-indigo-50/50 dark:bg-indigo-900/20 blur-[150px] rounded-full -translate-y-1/2 translate-x-1/2 pointer-events-none"></div>
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
                        <a
                            ...
                            className="flex items-center justify-center gap-2.5 px-8 py-4 w-full sm:w-auto rounded-xl border-2 border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 font-bold bg-white dark:bg-slate-800 hover:border-indigo-600 dark:hover:border-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50/30 dark:hover:bg-indigo-900/30 transition-all duration-300 shadow-sm"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center justify-center gap-2.5 px-8 py-4 w-full sm:w-auto rounded-xl border-2 border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 font-bold bg-white dark:bg-slate-800 hover:border-blue-600 dark:hover:border-blue-500 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50/30 dark:hover:bg-blue-900/30 transition-all duration-300 shadow-sm"
                        >
